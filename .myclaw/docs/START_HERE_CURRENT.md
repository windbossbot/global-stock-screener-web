...
- 루트 참고 문서는 `README.md`, `DEPLOY_WEB.md` 만 유지하고, 기본 current truth 는 `.myclaw` 쪽입니다.
- Git 기준은 이 폴더 하나로 복구/통일하는 것이 원칙입니다.

## Pull Next Only If Needed

1. `C:\Users\KGWPC\workspace\dividend-screener-v3\README.md`
2. `C:\Users\KGWPC\workspace\dividend-screener-v3\DEPLOY_WEB.md`
3. `C:\Users\KGWPC\workspace\dividend-screener-v3\.myclaw\docs\PROJECT_BOOTSTRAP_CURRENT.md`
4. `C:\Users\KGWPC\workspace\myclaw\docs\PROJECT_NEST_BOOTSTRAP_CURRENT.md`
...
App feature cleanup such as Google removal and financial filters is already reflected in current truth and should stay aligned with `app.py`.
